namespace LaunchCamPlus.CameraPanels
{
    partial class SpiralDemoCameraPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            WPointXColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            label1 = new Label();
            WPointYColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            label2 = new Label();
            WPointZColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            label3 = new Label();
            AxisZColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            label4 = new Label();
            AxisYColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            label5 = new Label();
            AxisXColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            label6 = new Label();
            ...
            label8 = new Label();
            label7 = new Label();
            Num1BColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
            Num1AColourNumericUpDown = new LaunchCamPlus.ExtraControls.ColourNumericUpDown();
