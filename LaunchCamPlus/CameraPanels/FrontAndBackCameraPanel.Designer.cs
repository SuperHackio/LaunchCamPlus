...
{
    partial class FrontAndBackCameraPanel
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            AngleAColourNumericUpDown.Maximum = new decimal(new int[] { 360, 0, 0, 0 });
            AngleAColourNumericUpDown.Minimum = new decimal(new int[] { 360, 0, 0, int.MinValue });
            ...
            AngleALabel.Font = new Font("Microsoft Sans Serif", 7.25F);
            AngleALabel.Location = new Point(2, 95);
            AngleALabel.Name = "AngleALabel";
            AngleALabel.Size = new Size(56, 26);
            ...
            AngleBLabel.Font = new Font("Microsoft Sans Serif", 7.25F);
            AngleBLabel.Location = new Point(1, 68);
            AngleBLabel.Name = "AngleBLabel";
            AngleBLabel.Size = new Size(56, 26);
            ...
            WPointVector3NumericUpDown.Text = "Core Position";
            // 
            ...
            AxisVector3NumericUpDown.Text = "Core Axis Normal";
            // 
            // FrontAndBackCameraPanel
            // 
