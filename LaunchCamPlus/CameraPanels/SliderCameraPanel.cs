...
public partial class SliderCameraPanel : CameraPanelBase
{
    public SliderCameraPanel()
    {
        InitializeComponent();
    ...
    public override void LoadCamera(BCAM.Entry Entry)
    {
        ...
        SpeedColourNumericUpDown.Value = (decimal)Math.Clamp(Entry.AxisX, 0.0f, 1.0f);
    ...
    public override void UnloadCamera()
    {
        ...
        Item.AxisX = (float)SpeedColourNumericUpDown.Value;
