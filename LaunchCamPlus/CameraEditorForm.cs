        ...
        PreBufferedPanels = new()
            {
                ...
                //{ "CAM_TYPE_TOWER_POS", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_TRIPOD_PLANET", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_DEAD", new ...() { Dock = DockStyle.Fill } }, // Is this actually useful?
                //{ "CAM_TYPE_INWARD_SPHERE", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_RAIL_DEMO", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_RAIL_FOLLOW", new RailFollowCameraPanel() { Dock = DockStyle.Fill } }, // HIGH PRIORITY
                //{ "CAM_TYPE_TRIPOD_BOSS_JOINT", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_CHARMED_TRIPOD_BOSS", new ...() { Dock = DockStyle.Fill } },
                ...
                //{ "CAM_TYPE_GROUND", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_TRUNDLE", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_SPHERE_TRUNDLE", new ...() { Dock = DockStyle.Fill } },
                { "CAM_TYPE_CUBE_PLANET", new CubePlanetCameraPanel() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_INNER_CYLINDER", new ...() { Dock = DockStyle.Fill } },
                { "CAM_TYPE_SPIRAL_DEMO", new SpiralDemoCameraPanel() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_TALK", new ...() { Dock = DockStyle.Fill } }, // Is this actually useful?
                //{ "CAM_TYPE_MTXREG_PARALLEL", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_CHARMED_VECREG", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_MEDIAN_PLANET", new ...() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_TWISTED_PASSAGE", new ...() { Dock = DockStyle.Fill } }, // HIGH PRIORITY
                //{ "CAM_TYPE_MEDIAN_TOWER", new ...() { Dock = DockStyle.Fill } }, // How is this different from TOWER?
                //{ "CAM_TYPE_CHARMED_VECREG_TOWER", new ...() { Dock = DockStyle.Fill } },
                { "CAM_TYPE_FRONT_AND_BACK", new FrontAndBackCameraPanel() { Dock = DockStyle.Fill } },
                //{ "CAM_TYPE_RACE_FOLLOW", new ...() { Dock = DockStyle.Fill } },
                ...
                //{ "CAM_TYPE_WATER_FOLLOW", new ...() { Dock = DockStyle.Fill } },
